...
<head>
  ...
  <title>SIIES | GESTOR ACTIVIDADES</title>
...
-->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    -->
      <span class="brand-text font-weight-light"><b>ADMINISTRADOR</b></span>
    </a>
    ...
    -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!--Aqui se puede reutilizar...<li class="nav-item">
            <a href="#" class="nav-link">
          ...
          <li class="nav-item">
            <a href="./?view=equipos_ssd&opt=all" class="nav-link">
          ...
          <li class="nav-item">
            <a href="./?view=toners&opt=all" class="nav-link">
...
<!--
  ...
  <footer class="main-footer">
    <strong><a href="">SIIES</a> &copy; 2023 </strong>
